...
#    auth_sign_up: "New to Ozaria? Create an Account"
    ...
    email_or_username: "El. paštas arba naudotojo vardas" # {change}
#    or: "or"
    log_in: "Prisijungti"
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Prisijungti su Facebook" # {change}
    sign_in_with_gplus: "Prisijungti su G+" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Redaktoriaus konfigūravimas" # {change}
    editor_config_livecompletion_label: "Automatinis žodžių užpildymas " # {change}
    ...
    editor_config_behaviors_label: "Išmanusis redagavimas" # {change}
