...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "Crează cont"
    email_or_username: "Email sau nume de utilizator" # {change}
#    or: "or"
    log_in: "Log In"
#    sign_in: "Sign In"
    ...
    finishing: "Terminare"
    sign_in_with_facebook: "Conectați-vă cu Facebook" # {change}
    sign_in_with_gplus: "Conectați-vă cu G+" # {change}
...
#    individual_users_not_supported: "Ozaria is for classrooms only!  Please visit CodeCombat to continue playing!"
  ...
  signup:
    ...
    write_this_down: "Notează asta:" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Configurare Editor" # {change}
    editor_config_livecompletion_label: "Autocompletare Live" # {change}
    ...
    editor_config_behaviors_label: "Comportamente inteligente" # {change}
