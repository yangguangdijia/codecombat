...
#    auth_sign_up: "New to Ozaria? Create an Account"
    ...
    email_or_username: "E-mail или корисничко име" # {change}
#    or: "or"
    log_in: "Најави се"
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Најави се со Facebook" # {change}
    sign_in_with_gplus: "Најави се со G+" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Подесувања на едитор" # {change}
    editor_config_livecompletion_label: "Автоматско дополнување 'во живо'" # {change}
    ...
    editor_config_behaviors_label: "Паметно однесување" # {change}
